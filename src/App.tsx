...
import { Car, Menu, X, Globe, Phone, Mail, Instagram, MessageCircle, LayoutDashboard, LogOut, Plus } from 'lucide-react';
            ...
            {featuredVehicles.map((car, i) => (
              ...
              >
                <div className="h-64 overflow-hidden relative">
                  ...
                  <div className="absolute top-4 right-4 bg-gold text-black text-[10px] font-black px-3 py-1 rounded-full uppercase tracking-widest">
                    {car.category}
                  </div>
                </div>
                <div className="p-6">
                  <h3 className="text-xl font-bold text-white mb-2">{car.name}</h3>
                  <p className="text-gold font-bold text-xl mb-6">{car.pricePerDay} MAD<span className="text-xs text-white/50 font-normal">/day</span></p>
                  <Link to={`/car/${car.id}`} className="block w-full text-center border border-white/10 text-white font-bold py-3 rounded-lg hover:bg-white hover:text-black transition-all">
                    View Details
                  </Link>
                </div>
              </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {vehicles.map(vehicle => (
            <motion.div 
              ...
              className="bg-zinc-900 rounded-2xl overflow-hidden border border-white/10 hover:border-gold/50 transition-all group"
            >
              <div className="h-64 overflow-hidden relative">
                <img src={vehicle.images[0]} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" alt={vehicle.name} />
              ...
              <div className="p-6">
                ...
                <div className="flex justify-between items-center mb-6">
                  <span className="text-gold font-bold text-2xl">{vehicle.pricePerDay} MAD<span className="text-xs text-white/50 font-normal">/day</span></span>
                </div>
                <div className="grid grid-cols-2 gap-4 mb-6 text-xs text-white/60">
                ...
                <Link to={`/car/${vehicle.id}`} className="block w-full text-center bg-white text-black font-bold py-3 rounded-lg hover:bg-gold transition-colors">
                  Book Now
                </Link>
              </div>
            </motion.div>
            ...
            <div className="bg-zinc-900/50 p-6 rounded-2xl border border-white/5">
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="flex items-center space-x-3">
                  <div className="w-8 h-8 bg-black rounded flex items-center justify-center text-gold"><Car size={16} /></div>
                  <div>
                    <p className="text-[10px] text-white/40 uppercase font-bold tracking-tighter">Engine</p>
                    <p className="text-sm text-white font-medium">{car.specs.engine}</p>
                  </div>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-8 h-8 bg-black rounded flex items-center justify-center text-gold"><Globe size={16} /></div>
                  <div>
                ...
                <div className="flex items-center space-x-3">
                  <div className="w-8 h-8 bg-black rounded flex items-center justify-center text-gold"><Phone size={16} /></div>
                  <div>
                ...
                <div className="flex items-center space-x-3">
                  <div className="w-8 h-8 bg-black rounded flex items-center justify-center text-gold"><Mail size={16} /></div>
                  <div>
